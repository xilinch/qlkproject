...
public class SearchActivity2 extends MActivity {
    ...
    public void initWidgets() {
        ...
        title_fragment.setDbParams(XCSearchRecordModelDb.TABLE_2, MDbConfig.DB_NAME_SEARCH_RECODER, MDbConfig.DB_VERSION_SEARCH_RECODER);
        ...
        title_fragment.setOnEditTextClicklistener(new XCTitleSearchFragment.OnEditTextClickedListener() {
            ...
            public void clicked() {
                ...
                if (record_fragment == null) {
                    ...
                    record_fragment.setDbParams(XCSearchRecordModelDb.TABLE_2, MDbConfig.DB_NAME_SEARCH_RECODER, MDbConfig.DB_VERSION_SEARCH_RECODER);
